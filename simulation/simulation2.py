...
speeds = {'car':2.25, 'bus':1.8, 'truck':1.8, 'car2':2, 'bike':2.5}  # average speeds of vehicles
...
vehicleTypes = {0:'car', 1:'bus', 2:'truck', 3:'car2', 4:'bike'}
...
def setTime():
    global noOfCars, noOfBikes, noOfBuses, noOfTrucks, noOfCar2, noOfLanes
    global carTime, busTime, truckTime, car2Time, bikeTime
...
#    greenTime = math.ceil(((noOfCars*carTime) + (noOfCar2*car2Time) + (noOfBuses*busTime) + (noOfBikes*bikeTime))/(noOfLanes+1))
...
#       greenTime = defaultMaximum
    ...
    noOfCars, noOfBuses, noOfTrucks, noOfCar2, noOfBikes = 0,0,0,0,0
        ...
        for j in range(len(vehicles[directionNumbers[nextGreen]][i])):
            ...
            if(vehicle.crossed==0):
                ...
                if(vclass=='car'):
                    ...
                    noOfCar2 += 1
    # print(noOfCars)
    greenTime = math.ceil(((noOfCars*carTime) + (noOfCar2*car2Time) + (noOfBuses*busTime) + (noOfTrucks*truckTime)+ (noOfBikes*bikeTime))/(noOfLanes+1))
...
class Main:
    ...
    background = pygame.image.load('images/mod_int-01.png')
